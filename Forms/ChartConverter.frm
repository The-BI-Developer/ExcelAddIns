VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ChartConverter 
   Caption         =   "Charts to PowerPoint"
   ClientHeight    =   2565
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   9585.001
   OleObjectBlob   =   "ChartConverter.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "ChartConverter"
